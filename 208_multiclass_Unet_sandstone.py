...
#C:\Users\seeho\mushroom_dataset\med_images\patches\masks

for directory_path in glob.glob("mushroom_dataset/med_images/patches/images/"):
...
train_masks = [] 
for directory_path in glob.glob("mushroom_dataset/med_images/patches/masks/"):
